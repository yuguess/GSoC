...
DataMergeGui::DataMergeGui(QWidget* pParent, const char* pName, bool modal)
: QDialog(pParent)
{
   if (pName == NULL)
   {
...
void DataMergeGui::generateNewView()
{
   Service<DesktopServices> pDesktop;
